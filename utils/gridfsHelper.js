...
const getRfqDocumentsGridFS = () => {
  if (!rfqDocumentsGridFS) {
    rfqDocumentsGridFS = new GridFSHelper('rfqDocuments');
  }
  return rfqDocumentsGridFS;
};
...
module.exports = {
  ...
  get rfqDocumentsGridFS() { return getRfqDocumentsGridFS(); }
};
