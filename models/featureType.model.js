...
featureTypeSchema.pre('save', function(next) {
...
featureTypeSchema.pre(['updateOne', 'findOneAndUpdate', 'findByIdAndUpdate'], function(next) {
...
// Indexes
featureTypeSchema.index({ name: 1 }, { unique: true });
featureTypeSchema.index({ shortName: 1 }, { unique: true });
